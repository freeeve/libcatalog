...
// The MARC <-> BIBFRAME fidelity contract as a consumable table:
...
// to CoreFields, v0.11.0 moved 306/347/490/511/521/533/538/776
// , and v0.12.0 finished 006/007. These tags are what
// the lcat:marcVerbatim sidecar stores at MARC ingest so exports and the
// MARC view can reproduce the original forms.
...
// beside, not instead of, the named graphs.)
var KnownLoss = map[string]string{
	...
	// Editorial whole/part links have no MARC emission yet:
	...
	// (758 external-identity links, are no longer lost: libcodex v0.29.0
	// crosswalks owl:sameAs / bf:hasEquivalent to MARC 758 $1 on decode, so the
	// enrichment hub links now reach MARC exports. Removed here.)
}
